...
// Batch Info Component - Minimal version with only batch name
  ...
  return (
    <Card className='bg-gradient-to-br from-blue-900/30 to-purple-900/30 border border-blue-500/20'>
      <CardHeader className='pb-2'>
        <CardTitle className='text-white text-lg'>Your Batch</CardTitle>
      </CardHeader>
      <CardContent>
        <div className='flex flex-col items-center justify-center'>
          {/* Only Batch Name - Centered and clean */}
          <div className='text-center py-2'>
            <div className='bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-4 rounded-xl text-2xl font-bold shadow-lg'>
              {batchName}
            </div>
          </div>
        </div>
